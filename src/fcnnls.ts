...
interface Options {
  ...
  // by default this number is 5, i.e
  // 0.0000001 is chopped to 0.00000
  // and allows discarding very small values
...
export default function fcnnls(
  ...
  const { maxIterations = X.columns * 3, gradientToleranceDecimals = 5 } =
    options;
